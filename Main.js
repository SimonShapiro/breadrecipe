...
var $author$project$Main$CalculatingRecipe = F2(
	function (a, b) {
		return {$: 'CalculatingRecipe', a: a, b: b};
	});
...
var $author$project$Main$calculateRecipe = function (parms) {
	var totalWater = $elm$core$Basics$round((parms.totalFlour * parms.hydration) / 100.0);
	var starterAmount = $elm$core$Basics$round((parms.totalFlour * parms.starterPercent) / 100.0);
...
var $author$project$Main$initParms = {hydration: 70, saltPercent: 2, starterPercent: 20, totalFlour: 500};
var $author$project$Main$init = A2(
	$author$project$Main$CalculatingRecipe,
	$author$project$Main$initParms,
	$author$project$Main$calculateRecipe($author$project$Main$initParms));
...
var $author$project$Main$CalculatingEnriched = F2(
	function (a, b) {
		return {$: 'CalculatingEnriched', a: a, b: b};
	});
var $author$project$Main$calculateEnrichedRecipe = function (parms) {
	var totalWater = $elm$core$Basics$round((parms.totalFlour * parms.hydration) / 100.0);
	var starterAmount = $elm$core$Basics$round((parms.totalFlour * parms.starterPercent) / 100.0);
	var starterWater = (starterAmount / 2) | 0;
	var starterFlour = starterWater;
	...
	function (msg, model) {
		if (model.$ === 'CalculatingRecipe') {
			...
			switch (msg.$) {
						...
						return _Utils_update(
							p,
							{
								totalFlour: A2(
									...
									0,
									$elm$core$String$toInt(newFlour))
							});
					}(parms);
					return A2(
						$author$project$Main$CalculatingRecipe,
						parameters,
						$author$project$Main$calculateRecipe(parameters));
						...
						return _Utils_update(
							p,
							{
								hydration: A2(
									$elm$core$Maybe$withDefault,
									0.0,
									$elm$core$String$toFloat(newHydration))
							});
					}(parms);
					var recipe = $author$project$Main$calculateRecipe(parameters);
					return A2(
						$author$project$Main$CalculatingRecipe,
						parameters,
						$author$project$Main$calculateRecipe(parameters));
						...
						return _Utils_update(
							p,
							{
								starterPercent: A2(
									$elm$core$Maybe$withDefault,
									0.0,
									$elm$core$String$toFloat(newStarter))
							});
					}(parms);
					return A2(
						$author$project$Main$CalculatingRecipe,
				...
				case 'SelectEnriched':
					return A2(
						$author$project$Main$CalculatingEnriched,
						parms,
						$author$project$Main$calculateEnrichedRecipe(parms));
				default:
					return A2(
						$author$project$Main$CalculatingRecipe,
						parms,
						$author$project$Main$calculateRecipe(parms));
			}
		} else {
			var parms = model.a;
			var rec = model.b;
			switch (msg.$) {
				case 'ChangeTotalFlour':
					...
					return A2(
						$author$project$Main$CalculatingEnriched,
						parameters,
						$author$project$Main$calculateEnrichedRecipe(parameters));
				case 'ChangeHydration':
					var newHydration = msg.a;
					var parameters = function (p) {
						return _Utils_update(
...
var $author$project$Main$Enriched = {$: 'Enriched'};
...
var $author$project$Main$header = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('SOURDOUGH MASTER')
				]))
		]));
...
var $author$project$Main$inputParameters = function (parms) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$core$String$fromInt(parms.totalFlour)),
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$value(
								$elm$core$String$fromFloat(parms.hydration)),
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$value(
								$elm$core$String$fromFloat(parms.starterPercent)),
...
var $author$project$Main$SelectEnriched = {$: 'SelectEnriched'};
var $author$project$Main$SelectNormal = {$: 'SelectNormal'};
...
var $author$project$Main$typeSelector = function (formula) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onClick($author$project$Main$SelectNormal)
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('normal'),
										$elm$html$Html$Events$onClick($author$project$Main$SelectEnriched)
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Enriched')
									]))
							]));
				} else {
					return A2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Main$typeSelector($author$project$Main$Normal),
							$author$project$Main$inputParameters(parms),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
								[
								...
								[
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$text(
											$elm$core$String$fromInt(recipe.recipeFlour))
										])),
									A2(
									$elm$html$Html$div,
									_List_Nil,
									_List_fromArray(
										[
											...
											$elm$html$Html$text(
											$elm$core$String$fromInt(recipe.recipeWater))
										])),
									A2(
									$elm$html$Html$div,
									_List_Nil,
									_List_fromArray(
										[
											...
											$elm$html$Html$text(
											$elm$core$String$fromInt(recipe.starterAmount))
										])),
									A2(
									$elm$html$Html$div,
									_List_Nil,
									_List_fromArray(
										[
											...
											$elm$html$Html$text(
											$elm$core$String$fromInt(recipe.saltAmount))
										])),
									A2(
									$elm$html$Html$div,
									_List_Nil,
									_List_fromArray(
										[
											...
											$elm$html$Html$text(
											$elm$core$String$fromInt(recipe.totalDoughWeight))
										]))
								]))
						]))
				]));
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Main$typeSelector($author$project$Main$Enriched),
							$author$project$Main$inputParameters(parms),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Recipe Milk '),
											$elm$html$Html$text(
											$elm$core$String$fromInt(recipe.recipeMilk))
										])),
									A2(
									$elm$html$Html$div,
									_List_Nil,
									_List_fromArray(
										[
											$elm$html$Html$text('Recipe Eggs '),
											$elm$html$Html$text(
											$elm$core$String$fromInt(recipe.recipeEggs))
										])),
									A2(
									$elm$html$Html$div,
									_List_Nil,
									_List_fromArray(
										[
											$elm$html$Html$text(' (Milk + Eggs) '),
											$elm$html$Html$text(
											$elm$core$String$fromInt(recipe.recipeMilk + recipe.recipeEggs))
										])),
									A2(
									$elm$html$Html$div,
									_List_Nil,
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Recipe Sugar '),
											$elm$html$Html$text(
											$elm$core$String$fromInt(recipe.recipeSugar))
										])),
									A2(
									$elm$html$Html$div,
									_List_Nil,
									_List_fromArray(
										[
											$elm$html$Html$text('Recipe Butter '),
											$elm$html$Html$text(
											$elm$core$String$fromInt(recipe.recipeButter))
										])),
									A2(
									$elm$html$Html$div,
									_List_Nil,
